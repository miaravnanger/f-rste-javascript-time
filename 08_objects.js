...
console.log(person.name); //targets value with dot notation
console.log(person["age"]); //target with bracket notation

//dot vs bracket: use dot when you know the key name code time: person.name. Use brackets when the key is dynamic or not a valid identifier: person[Key]
